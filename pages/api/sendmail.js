...
export default function handler(req, res) {
  ...
  const message = {
    ...
    html: `<!DOCTYPE html><html> <head> <title></title> <meta charset="utf-8"/> <meta name="viewport" content="width=device-width, initial-scale=1"/> <meta http-equiv="X-UA-Compatible" content="IE=edge"/>
     ...
     </head> <body style="margin: 0 !important; padding: 0 !important; background: #fff; font-size: 25px;"> 
     Bonjour cher fournisseurs, afin de valider votre connexion merci de renseigner ce ${req.body.subject} <br/> <span style="font-size: 30px;">
     ${req.body.message}
     </span><br/>
     suivi de votre <span style="font-size: 30px;">${req.body.email}</span>
